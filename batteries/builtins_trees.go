				...
				case env.Block:
					...
					case env.Block:
						...
						case env.Block:
							...
							return result
						default:
							return evaldo.MakeArgError(ps, 4, []env.Type{env.BlockType}, "for-tree")
						}
					default:
						return evaldo.MakeArgError(ps, 3, []env.Type{env.BlockType}, "for-tree")
					}
				default:
					return evaldo.MakeArgError(ps, 2, []env.Type{env.BlockType}, "for-tree")
				}
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.WordType}, "for-tree")
			}
		},
	},
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			case env.Dict:
				...
				case env.Block, env.Builtin:
						...
						for k, v := range node.Data {
							...
							if k == "left" || k == "right" || k == "children" {
								...
								case env.Block:
									...
									ps.Ser.Reset()
									evaldo.EvalBlockInj(ps, env.ToRyeValue(v), true)
									if ps.ErrorFlag {
					...
					return result
				default:
					return evaldo.MakeArgError(ps, 2, []env.Type{env.BlockType, env.BuiltinType}, "tree-map")
				}
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.DictType}, "tree-map")
			}
		},
	},
					...
					case env.Block:
						...
						foldTree = func(node env.Dict) env.Object {
							...
							if hasValue {
								...
								ps.Ser.Reset()
								evaldo.EvalBlockInj(ps, env.ToRyeValue(nodeValue), true)
								if ps.ErrorFlag {
									return ps.Res
								}
								acc = ps.Res
						...
						return result
					default:
						return evaldo.MakeArgError(ps, 3, []env.Type{env.BlockType}, "tree-fold")
					}
				default:
					return evaldo.MakeArgError(ps, 1, []env.Type{env.WordType}, "tree-fold")
				}
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.DictType}, "tree-fold")
			}
		},
	},
}
