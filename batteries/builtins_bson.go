...
func BsonToValue_Map(ps *env.ProgramState, val any, typ string, meta any, topLevel bool) env.Object {
	...
	case bson.A:
		...
		default:
			return evaldo.MakeBuiltinError(ps, "No matching arguments found.", "BsonToValue_Map")
		}
	}
	return evaldo.MakeBuiltinError(ps, "bson type not found.", "BsonToValue_Map")
}
...
func BsonToValue_Val(ps *env.ProgramState, val any, topLevel bool) env.Object {
	...
	case bson.M:
		...
		return val
	default:
		return evaldo.MakeBuiltinError(ps, "bson type not found.", "BsonToValue_Val")
	}
}
...
var Builtins_bson = map[string]*env.Builtin{
	...
	"from-bson": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			// return evaldo.MakeError(ps, "bson type not found")
		},
	},
	// Tests:
