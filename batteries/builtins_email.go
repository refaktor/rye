...
func __setHeader(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		...
		default:
			return evaldo.MakeArgError(ps, 3, []env.Type{env.StringType, env.EmailType}, "gomail-message//Set-header")
		}
		...
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType, env.TagwordType}, "gomail-message//Set-header")
		}
		...
		if fld != "" && val != "" {
			...
			return evaldo.MakeBuiltinError(ps, "Not both values were defined.", "gomail-message//Set-header")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "gomail-message//Set-header")
	}
}
	...
	case env.Native:
		...
		case env.String:
			...
			case env.String:
				...
				default:
					ps.FailureFlag = true
					return evaldo.MakeArgError(ps, 4, []env.Type{env.StringType}, "gomail-message//Set-address-header")
				}
			default:
				ps.FailureFlag = true
				return evaldo.MakeArgError(ps, 3, []env.Type{env.StringType}, "gomail-message//Set-address-header")
			}
		default:
			ps.FailureFlag = true
			return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "gomail-message//Set-address-header")
		}
	default:
		ps.FailureFlag = true
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "gomail-message//Set-address-header")
	}
}
...
func __setBody(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		...
		case env.String:
			...
			default:
				ps.FailureFlag = true
				return evaldo.MakeArgError(ps, 3, []env.Type{env.StringType}, "gomail-message//Set-body")
			}
		default:
			ps.FailureFlag = true
			return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "gomail-message//Set-body")
		}
	default:
		ps.FailureFlag = true
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "gomail-message//Set-body")
	}
}
...
func __attach(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		...
		default:
			ps.FailureFlag = true
			return evaldo.MakeArgError(ps, 2, []env.Type{env.UriType}, "gomail-message//Attach")
		}
	default:
		ps.FailureFlag = true
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "gomail-message//Attach")
	}
}
...
func __addAlternative(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		...
		case env.String:
			...
			default:
				ps.FailureFlag = true
				return evaldo.MakeArgError(ps, 3, []env.Type{env.StringType}, "gomail-message//Add-alternative")
			}
		default:
			ps.FailureFlag = true
			return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "gomail-message//Add-alternative")
		}
	default:
		ps.FailureFlag = true
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "gomail-message//Add-alternative")
	}
}
	...
	case env.String:
		...
		case env.Integer:
			...
			case env.String:
				...
				default:
					ps.FailureFlag = true
					return evaldo.MakeArgError(ps, 4, []env.Type{env.StringType}, "new-email-dialer")
				}
			default:
				ps.FailureFlag = true
				return evaldo.MakeArgError(ps, 3, []env.Type{env.StringType}, "new-email-dialer")
			}
		default:
			ps.FailureFlag = true
			return evaldo.MakeArgError(ps, 2, []env.Type{env.IntegerType}, "new-email-dialer")
		}
	default:
		ps.FailureFlag = true
		return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "new-email-dialer")
	}
}
...
func __dialAndSend(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		...
		default:
			ps.FailureFlag = true
			return evaldo.MakeArgError(ps, 2, []env.Type{env.NativeType}, "gomail-dialer//Dial-and-send")
		}
	default:
		ps.FailureFlag = true
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "gomail-dialer//Dial-and-send")
	}
}
