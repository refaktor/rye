...
func Stck_CallBuiltin(bi env.Builtin, ps *env.ProgramState, arg0_ env.Object, toLeft bool) *env.ProgramState {
	evalExprFn := evaldo.EvalExpression_CollectArg
	var arg0 env.Object
	var arg1 env.Object
...
func Stck_EvalObject(ps *env.ProgramState, object env.Object, leftVal env.Object, toLeft bool, ctx *env.RyeCtx) *env.ProgramState {
	...
	case env.BuiltinType:
		...
		if evaldo.CheckForFailureWithBuiltin(bu, ps, 333) {
			return ps
		}
	...
	case env.CurriedCallerType:
		...
		evaldo.CallCurriedCaller(cc, ps, leftVal, toLeft, false, nil, false, false)
		return ps
	default:
