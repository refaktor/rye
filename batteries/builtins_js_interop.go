...
var Builtins_js_interop = map[string]*env.Builtin{
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			case env.String:
				...
				if jsFunc.IsUndefined() {
					return evaldo.MakeBuiltinError(ps, "JavaScript function not found: "+funcName.Value, "js-call")
				}
			...
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "js-call")
			}
		},
	},
	...
	"___js-get": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			case env.String:
				...
				if jsFunc.IsUndefined() {
					return evaldo.MakeBuiltinError(ps, "JavaScript function 'jsGet' not available", "js-get")
				}
				...
				for {
					...
					if !result.IsUndefined() && result.Get("ready").Bool() {
						...
						if result.Get("success").Bool() {
							...
							return evaldo.MakeBuiltinError(ps, "HTTP request failed: "+result.Get("error").String(), "js-get")
						}
					}
				...
				js.Global().Get("__ryeAsyncResults").Delete(resultId)
				return evaldo.MakeBuiltinError(ps, "HTTP request timed out", "js-get")
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "js-get")
			}
		},
	},
	...
	"__js-post": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			case env.String:
				...
				if jsFunc.IsUndefined() {
					return evaldo.MakeBuiltinError(ps, "JavaScript function 'jsPost' not available", "js-post")
				}
				...
				case result := <-done:
					return jsToRye(result, ps)
				case err := <-errChan:
					return evaldo.MakeBuiltinError(ps, "HTTP POST failed: "+err.String(), "js-post")
				}
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "js-post")
			}
		},
	},
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			case env.String:
				...
				case env.String:
					...
					if jsFunc.IsUndefined() {
						return evaldo.MakeBuiltinError(ps, "JavaScript function 'jsAuthenticatedRequest' not available", "js-authenticated-request")
					}
					...
					case result := <-done:
						return jsToRye(result, ps)
					case err := <-errChan:
						return evaldo.MakeBuiltinError(ps, "Authenticated request failed: "+err.String(), "js-authenticated-request")
					}
				default:
					return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "js-authenticated-request")
				}
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "js-authenticated-request")
			}
		},
	},
	...
	"js-to-csv": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			if jsFunc.IsUndefined() {
				return evaldo.MakeBuiltinError(ps, "JavaScript function 'jsToCsv' not available", "js-to-csv")
			}
	...
	"js-to-xml": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			if jsFunc.IsUndefined() {
				return evaldo.MakeBuiltinError(ps, "JavaScript function 'jsToXml' not available", "js-to-xml")
			}
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			case env.String:
				...
				case env.String:
					...
					if jsFunc.IsUndefined() {
						return evaldo.MakeBuiltinError(ps, "JavaScript function 'jsDownload' not available", "js-download")
					}
					...
					return *env.NewString(result.String())
				default:
					return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "js-download")
				}
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "js-download")
			}
		},
	},
	...
	"js-prompt": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			if arg0 == nil {
				return evaldo.MakeBuiltinError(ps, "js-prompt expects 1 or 2 arguments", "js-prompt")
			}
	...
	"js-call-callback": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			if !ok {
				return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "js-call-callback")
			}
			callback, ok := arg2.(env.Function)
			if !ok {
				return evaldo.MakeArgError(ps, 3, []env.Type{env.FunctionType}, "js-call-callback")
			}
			...
			if jsFunc.IsUndefined() {
				successCb.Release()
				errorCb.Release()
				return evaldo.MakeBuiltinError(ps, "JS function not found: "+funcName.Value, "js-call-callback")
			}
	...
	"js-display-table": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			if jsFunc.IsUndefined() {
				return evaldo.MakeBuiltinError(ps, "JavaScript function 'ryeDisplayTable' not available", "js-display-table")
			}
	...
	"js-sleep": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			case env.Integer:
				...
				return ms
			default:
				return evaldo.MakeArgError(ps, 1, []env.Type{env.IntegerType}, "js-sleep")
			}
		},
	},
