...
func __prometheus_new_counter(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.String:
		...
		case env.String:
			...
			if arg2 != nil {
				...
				case env.Dict:
					...
					for k, v := range labels.Data {
						...
						default:
							return evaldo.MakeBuiltinError(ps, "Label values must be strings", "prometheus//new-counter")
						}
					}
				default:
					return evaldo.MakeArgError(ps, 3, []env.Type{env.DictType}, "prometheus//new-counter")
				}
			}
			...
			if err != nil {
				return evaldo.MakeBuiltinError(ps, fmt.Sprintf("Failed to register counter: %v", err), "prometheus//new-counter")
			}

			return *env.NewNative(ps.Idx, counter, "prometheus-counter")
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "prometheus//new-counter")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "prometheus//new-counter")
	}
}
...
func __prometheus_counter_inc(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(counter.Kind.Index) != "prometheus-counter" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-counter", "prometheus-counter//inc")
		}

		counter.Value.(prometheus.Counter).Inc()
		return arg0
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-counter//inc")
	}
}
...
func __prometheus_counter_add(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(counter.Kind.Index) != "prometheus-counter" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-counter", "prometheus-counter//add")
		}
		...
		case env.Decimal:
			...
			return arg0
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.IntegerType, env.DecimalType}, "prometheus-counter//add")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-counter//add")
	}
}
...
func __prometheus_new_gauge(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.String:
		...
		case env.String:
				...
				case env.Dict:
					...
					for k, v := range labels.Data {
						...
						case env.String:
							constLabels[k] = val.Value
						default:
							return evaldo.MakeBuiltinError(ps, "Label values must be strings", "prometheus//new-gauge")
						}
					}
				default:
					return evaldo.MakeArgError(ps, 3, []env.Type{env.DictType}, "prometheus//new-gauge")
				}
			}
			...
			if err != nil {
				return evaldo.MakeBuiltinError(ps, fmt.Sprintf("Failed to register gauge: %v", err), "prometheus//new-gauge")
			}

			return *env.NewNative(ps.Idx, gauge, "prometheus-gauge")
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "prometheus//new-gauge")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "prometheus//new-gauge")
	}
}
...
func __prometheus_gauge_set(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(gauge.Kind.Index) != "prometheus-gauge" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-gauge", "prometheus-gauge//set")
		}
		...
		case env.Decimal:
			...
			return arg0
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.IntegerType, env.DecimalType}, "prometheus-gauge//set")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-gauge//set")
	}
}
...
func __prometheus_gauge_inc(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(gauge.Kind.Index) != "prometheus-gauge" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-gauge", "prometheus-gauge//inc")
		}

		gauge.Value.(prometheus.Gauge).Inc()
		return arg0
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-gauge//inc")
	}
}
...
func __prometheus_gauge_dec(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(gauge.Kind.Index) != "prometheus-gauge" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-gauge", "prometheus-gauge//dec")
		}

		gauge.Value.(prometheus.Gauge).Dec()
		return arg0
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-gauge//dec")
	}
}
...
func __prometheus_gauge_add(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(gauge.Kind.Index) != "prometheus-gauge" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-gauge", "prometheus-gauge//add")
		}
		...
		case env.Decimal:
			...
			return arg0
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.IntegerType, env.DecimalType}, "prometheus-gauge//add")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-gauge//add")
	}
}
...
func __prometheus_gauge_sub(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(gauge.Kind.Index) != "prometheus-gauge" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-gauge", "prometheus-gauge//sub")
		}
		...
		case env.Decimal:
			...
			return arg0
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.IntegerType, env.DecimalType}, "prometheus-gauge//sub")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-gauge//sub")
	}
}
...
func __prometheus_new_histogram(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.String:
		...
		case env.String:
				...
				case env.Block:
					...
					for i := 0; i < bucketsObj.Series.Len(); i++ {
						...
						case env.Decimal:
							buckets[i] = val.Value
						default:
							return evaldo.MakeBuiltinError(ps, "Bucket values must be numbers", "prometheus//new-histogram")
						}
					}
				default:
					return evaldo.MakeArgError(ps, 3, []env.Type{env.BlockType}, "prometheus//new-histogram")
				}
			}
				...
				case env.Dict:
					...
					for k, v := range labels.Data {
						...
						case env.String:
							constLabels[k] = val.Value
						default:
							return evaldo.MakeBuiltinError(ps, "Label values must be strings", "prometheus//new-histogram")
						}
					}
				default:
					return evaldo.MakeArgError(ps, 4, []env.Type{env.DictType}, "prometheus//new-histogram")
				}
			}
			...
			if err != nil {
				return evaldo.MakeBuiltinError(ps, fmt.Sprintf("Failed to register histogram: %v", err), "prometheus//new-histogram")
			}

			return *env.NewNative(ps.Idx, histogram, "prometheus-histogram")
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "prometheus//new-histogram")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "prometheus//new-histogram")
	}
}
...
func __prometheus_histogram_observe(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(histogram.Kind.Index) != "prometheus-histogram" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-histogram", "prometheus-histogram//observe")
		}
		...
		case env.Decimal:
			...
			return arg0
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.IntegerType, env.DecimalType}, "prometheus-histogram//observe")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-histogram//observe")
	}
}
...
func __prometheus_new_summary(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.String:
		...
		case env.String:
				...
				case env.Dict:
					...
					for k, v := range objectivesObj.Data {
						...
						if q, err := strconv.ParseFloat(quantileStr, 64); err == nil {
							...
							return evaldo.MakeBuiltinError(ps, "Quantile must be a valid float64", "prometheus//new-summary")
						}
						...
						case env.Decimal:
							error = val.Value
						default:
							return evaldo.MakeBuiltinError(ps, "Error values must be numbers", "prometheus//new-summary")
						}

						objectives[quantile] = error
					}
				default:
					return evaldo.MakeArgError(ps, 3, []env.Type{env.DictType}, "prometheus//new-summary")
				}
			}
				...
				case env.Dict:
					...
					for k, v := range labels.Data {
						...
						case env.String:
							constLabels[k] = val.Value
						default:
							return evaldo.MakeBuiltinError(ps, "Label values must be strings", "prometheus//new-summary")
						}
					}
				default:
					return evaldo.MakeArgError(ps, 4, []env.Type{env.DictType}, "prometheus//new-summary")
				}
			}
			...
			if err != nil {
				return evaldo.MakeBuiltinError(ps, fmt.Sprintf("Failed to register summary: %v", err), "prometheus//new-summary")
			}

			return *env.NewNative(ps.Idx, summary, "prometheus-summary")
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.StringType}, "prometheus//new-summary")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "prometheus//new-summary")
	}
}
...
func __prometheus_summary_observe(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(summary.Kind.Index) != "prometheus-summary" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-summary", "prometheus-summary//observe")
		}
		...
		case env.Decimal:
			...
			return arg0
		default:
			return evaldo.MakeArgError(ps, 2, []env.Type{env.IntegerType, env.DecimalType}, "prometheus-summary//observe")
		}
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-summary//observe")
	}
}
...
func __prometheus_must_register(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		...
		if kindName != "prometheus-counter" &&
			...
			return evaldo.MakeBuiltinError(ps, "Expected a Prometheus collector", "prometheus//must-register")
		}
		...
		return arg0
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus//must-register")
	}
}
...
func __prometheus_start_http_server(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.StringType}, "prometheus//start-http-server")
	}
}
...
func __prometheus_mutex_lock(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(mutex.Kind.Index) != "prometheus-mutex" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-mutex", "prometheus-mutex//lock")
		}

		mutex.Value.(*sync.Mutex).Lock()
		return arg0
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-mutex//lock")
	}
}
...
func __prometheus_mutex_unlock(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
	...
	case env.Native:
		if ps.Idx.GetWord(mutex.Kind.Index) != "prometheus-mutex" {
			return evaldo.MakeBuiltinError(ps, "Expected a prometheus-mutex", "prometheus-mutex//unlock")
		}

		mutex.Value.(*sync.Mutex).Unlock()
		return arg0
	default:
		return evaldo.MakeArgError(ps, 1, []env.Type{env.NativeType}, "prometheus-mutex//unlock")
	}
}
