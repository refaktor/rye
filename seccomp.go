...
// InitSeccomp initializes the seccomp profile for Rye
// This is a build-time integration approach where the seccomp profile
// is embedded directly in the binary
func InitSeccomp() error {
	// Only apply seccomp on Linux
