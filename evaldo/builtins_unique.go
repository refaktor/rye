...
var builtins_unique = map[string]*env.Builtin{
	...
	"Rye-itself//Unique-id?": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			if err != nil {
				return MakeBuiltinError(ps, fmt.Sprintf("Failed to generate unique ID: %v", err), "Rye-itself//unique-id")
			}
	...
	"Rye-itself//Temp-dir?": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			uniqueID, err := generateProcessUniqueID()
			if err != nil {
				return MakeBuiltinError(ps, fmt.Sprintf("Failed to generate unique ID: %v", err), "Rye-itself//unique-temp-dir")
			}
			...
			if err != nil {
				return MakeBuiltinError(ps, fmt.Sprintf("Failed to create temp directory: %v", err), "Rye-itself//unique-temp-dir")
			}
	...
	"Rye-itself//Temp-file?": {
		...
		Fn: func(ps *env.ProgramState, arg0 env.Object, arg1 env.Object, arg2 env.Object, arg3 env.Object, arg4 env.Object) env.Object {
			...
			uniqueID, err := generateProcessUniqueID()
			if err != nil {
				return MakeBuiltinError(ps, fmt.Sprintf("Failed to generate unique ID: %v", err), "Rye-itself//unique-temp-file")
			}
