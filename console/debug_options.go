...
// init registers OfferDebuggingOptions into the evaldo hook so that evaldo.go can call it
// without creating a circular import (console imports evaldo, not the other way around).
func init() {
	evaldo.OfferDebuggingOptionsHook = OfferDebuggingOptions
}
